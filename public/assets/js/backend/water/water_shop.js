define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'water/water_shop/index' + location.search,
                    add_url: 'water/water_shop/add',
                    edit_url: 'water/water_shop/edit',
                    del_url: 'water/water_shop/del',
                    multi_url: 'water/water_shop/multi',
                    table: 'water_shop',
                }
            });
