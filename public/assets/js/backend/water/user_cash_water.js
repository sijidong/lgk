define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'water/user_cash_water/index' + location.search,
                    add_url: 'water/user_cash_water/add',
                    edit_url: 'water/user_cash_water/edit',
                    del_url: 'water/user_cash_water/del',
                    multi_url: 'water/user_cash_water/multi',
