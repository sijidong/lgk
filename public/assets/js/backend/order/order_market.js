define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order/order_market/index' + location.search,
                    add_url: 'order/order_market/add',
                    edit_url: 'order/order_market/edit',
                    del_url: 'order/order_market/del',
                    multi_url: 'order/order_market/multi',
                    table: 'order_market',
                }
            });
